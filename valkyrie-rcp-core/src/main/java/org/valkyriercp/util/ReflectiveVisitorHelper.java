...
public final class ReflectiveVisitorHelper {
    ...
    private Cache<Class, ClassVisitMethods> visitorClassVisitMethods = new Cache2kBuilder<Class, ClassVisitMethods>() {
    }
            .loader(ClassVisitMethods::new)
            .build();
    ...
    private Method getMethod(Class visitorClass, Object argument) {
        ClassVisitMethods visitMethods = this.visitorClassVisitMethods
                .get(visitorClass);
    ...
    private static class ClassVisitMethods {
        ...
        private Cache<Class, Method> visitMethodCache = new Cache2kBuilder<Class, Method>() {
        }
                .loader(argumentClazz -> {
