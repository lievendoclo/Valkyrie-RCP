...
public abstract class AbstractFormModel extends AbstractPropertyChangePublisher implements HierarchicalFormModel,
    ...
    private final Cache<String, RichClientConversionService> propertyConversionServices = new Cache2kBuilder<String, RichClientConversionService>() {
    }
            .loader(key -> new DefaultRichClientConversionService() {
    ...
    protected ValueModel createConvertingValueModel(String formProperty, Class targetClass) {
        ...
        final RichClientConversionService conversionService = getConversionService();
        ...
        if (propertyConversionServices.containsKey(formProperty)) {
            ...
            final RichClientConversionService propertyConversionService = propertyConversionServices
                    .get(formProperty);
    ...
    public void registerPropertyConverter(String propertyName, Converter toConverter, Converter fromConverter) {
        DefaultRichClientConversionService propertyConversionService = (DefaultRichClientConversionService) propertyConversionServices
                .get(propertyName);
    ...
    public RichClientConversionService getConversionService() {
    ...
    public void setConversionService(RichClientConversionService conversionService) {
