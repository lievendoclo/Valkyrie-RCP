...
public abstract class AbstractPropertyAccessStrategy implements MutablePropertyAccessStrategy {
    ...
    private final Cache<String, PropertyValueModel> valueModelCache;
    ...
    public AbstractPropertyAccessStrategy(final ValueModel domainObjectHolder) {
        ...
        this.valueModelCache = new Cache2kBuilder<String, PropertyValueModel>() {
        }
                .loader(propertyPath -> {
                    ...
                    ValueModel parentValueModel = parentPropertyPath == "" ? domainObjectHolder : getValueModelCache()
	...
	private Cache<String, PropertyValueModel> getValueModelCache() {
		return valueModelCache;
	}
    ...
    public ValueModel getPropertyValueModel(String propertyPath) throws BeansException {
        return valueModelCache.get(getFullPropertyPath(propertyPath));
    }
