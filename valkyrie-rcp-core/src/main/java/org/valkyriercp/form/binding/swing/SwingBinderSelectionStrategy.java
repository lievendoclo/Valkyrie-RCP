 ...
 */
public class SwingBinderSelectionStrategy extends
	 ...
	 * locate it into the application context, check whether it's a binder and
	...
	public Binder getIdBoundBinder(String id) {
		...
		if (binder == null) // try to locate the binder bean
		{
			...
			if (binderBean instanceof Binder) {
				...
				throw new IllegalArgumentException("Bean '" + id
