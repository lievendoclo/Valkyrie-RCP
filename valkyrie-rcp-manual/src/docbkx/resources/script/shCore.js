...
/*
	Modified for the BASE project by Nicklas Nordborg.
	The dp.sh.HighlightAll now looks for <tagname class="classname" language="language">
	Previously it looked for <pre class="language" name="name">
*/
//
// create namespaces
//
...
// highlightes all elements identified by tagName and className and gets source code from specified property
dp.sh.HighlightAll = function(tagName, className, showGutter /* optional */, showControls /* optional */, collapseAll /* optional */, firstLine /* optional */, showColumns /* optional */)
{
	function FindValue()
	{
		var a = arguments;
	...
	FindTagsByName(elements, className, tagName);
	...
	for(var i = 0; i < elements.length; i++)
	{
		...
		// XML is default without line numberering and controls
		if (language == 'xml')
		{
			highlighter.noGutter = !IsOptionSet('gutter', options);
			highlighter.addControls = IsOptionSet('controls', options);
		}
